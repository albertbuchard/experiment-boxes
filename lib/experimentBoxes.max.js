  ...
  _createClass(SmartModal, [{
    ...
    value: function updatePosition() {
      ...
      if (this.stayInWindow && this.boxElement.height() + topPos > innerHeight) {
        this.freeHeight = false;
        var offset = innerHeight - this.boxElement.height();
        ...
        if (!this.scrollAppended) {
          ...
          var scrollElement = (0, _jquery2.default)(this.boxElement).find('.smartmodal-scroll');
          this.contentElement.scroll(function () {
