...
var DragBox = function () {
  function DragBox() {
    ...
    this.keyhandler = this.keyfunction.bind(this);
    document.body.addEventListener('keydown', this.keyhandler, false);
    document.body.addEventListener('keyup', this.keyhandler, false);
    ...
    this.clickhandler = this.stopDrag.bind(this);
  ...
  _createClass(DragBox, [{
    ...
    value: function destroy() {
      ...
      (0, _jquery2.default)(this.boxElement).animate({
        ...
        document.body.removeEventListener('keydown', _this.keyhandler);
        document.body.removeEventListener('keyup', _this.keyhandler);
        document.body.removeEventListener('click', _this.clickhandler);
    ...
    value: function append(html) {
      ...
      var type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'append';
...
var BindedField = function (_BindedProperty) {
  ...
  function BindedField() {
    ...
    var _ref = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : {},
        ...
        _ref$baseMessage = _ref.baseMessage,
        baseMessage = _ref$baseMessage === undefined ? '' : _ref$baseMessage;
      ...
      case 'radio':
        ...
        try {
          for (var _iterator = _this.allowedValues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            html += '<div class="form-check">\n            <label class="form-check-label">\n              <input type="radio" class="form-check-input ' + _this.tempClass + '" name="' + property + idRadio + '" value="' + value + '" data-binded="' + property + '" checked>\n              ' + value + '\n            </label>\n          </div> ';
          }
        } catch (err) {
        ...
        break;
      default:
        (0, _utilities.debugError)('fieldType is invalid : input, selector and slider are the only valid type for now');
        return _possibleConstructorReturn(_this);
    }
  ...
  _createClass(BindedField, [{
    ...
    value: function placeInParent() {
      ...
      if (this.fieldType === 'radio') {
        ...
        this.messageDiv = (0, _jquery2.default)('.' + this.tempClass + '-message');
            ...
            if (keyVal.length > 2) {
              ...
              switch (key) {
                ...
                case 'contains':
                  ...
                  try {
                    for (var _iterator4 = val[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                      var char = _step4.value;

                      if (!char) {
                        (0, _utilities.debugError)('BindedField.parsedConstraints: Invalid values for the contains rule - ' + constraint);
                        continue;
                      }
                ...
                case 'score':
                  val[0] = Number(val[0].trim());
                  if (isNaN(val[0])) {
                    (0, _utilities.debugError)('BindedField.parsedConstraints: Invalid non numeric constraint value - ' + constraint);
                  } else {
                    var passwordScore = (0, _utilities.scorePassword)(this.value);
              ...
              switch (constraint) {
                ...
                case 'numeric':
                  ...
                  break;
                case 'date':
                  if ((0, _utilities.parseDate)(this.value) === null) {
    ...
    get: function get() {
      if (this.subfields.length) {
        ...
        try {
          for (var _iterator5 = this.subfields[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
var SmartModal = function (_DragBox) {
  ...
  function SmartModal() {
    var formatType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'topCentralLarge';
    ...
    var _ref = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : { stayInWindow: true, paddingTopBottom: 100, freeHeight: true },
        _ref$stayInWindow = _ref.stayInWindow,
        stayInWindow = _ref$stayInWindow === undefined ? true : _ref$stayInWindow,
        _ref$paddingTopBottom = _ref.paddingTopBottom,
        paddingTopBottom = _ref$paddingTopBottom === undefined ? 100 : _ref$paddingTopBottom,
    ...
    _this.formatType = _this.DEFAULT_FORMAT_TYPES.hasOwnProperty(formatType) ? formatType : 'topCentralLarge';
    _this.stayInWindow = stayInWindow;
    _this.freeHeight = freeHeight;
    _this.initialFreeHeigth = freeHeight;
    _this.maxHeight = null;
    _this.lastUpdate = 0;
    _this.paddingTopBottom = paddingTopBottom;
    _this.buttonRowHtml = _this.DEFAULT_BUTTON_ROW_HTML;
    _this.scrollAppended = false;
  ...
  _createClass(SmartModal, [{
    ...
    value: function updatePosition() {
      ...
      if (this.scrollAppended) {
        (0, _jquery2.default)(this.boxElement).find('.smartmodal-scroll').hide();
      }
      ...
      if (this.initialFreeHeigth && !this.freeHeight || this.stayInWindow && this.boxElement.height() + topPos > innerHeight - this.paddingTopBottom) {
        ...
        this.freeHeight = false;
        var offset = innerHeight - this.maxHeight;
      ...
      (0, _utilities.delay)(1).then(function () {
        if (!_this2.scrollAppended) {
          _this2.prepend('<span class="smartmodal-scroll">&darr; scroll down &darr;</span>', '.smartmodal-buttonrow');
          _this2.scrollAppended = true;
          var scrollElement = (0, _jquery2.default)(_this2.boxElement).find('.smartmodal-scroll');
          _this2.contentElement.scroll(function () {
            if (_this2.contentElement.scrollTop() !== 0) {
              scrollElement.hide();
            } else {
              scrollElement.show();
            }
        ...
        if (_this2.scrollAppended && _this2.contentElement.get(0).scrollHeight > _this2.contentElement.innerHeight()) {
          (0, _jquery2.default)(_this2.boxElement).find('.smartmodal-scroll').show();
        } else if (_this2.scrollAppended) {
          (0, _jquery2.default)(_this2.boxElement).find('.smartmodal-scroll').hide();
        }
      });
    ...
    set: function set(html) {
      ...
      if (this.boxElement) {
        ...
        (0, _utilities.delay)(10).then(function () {
          _this3.updatePosition();_this3.show();
        });
      }
    }
  }, {
    ...
    set: function set(html) {
      ...
      if (this.boxElement) {
        ...
        this.updateSize();
        (0, _utilities.delay)(10).then(function () {
          _this4.updatePosition();_this4.show();
        });
      }
    }
  }, {
    key: 'buttonText',
    set: function set() {
      var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Close';

      if ((0, _utilities.hasConstructor)(_jquery2.default, this.button) && (0, _utilities.hasConstructor)(String, text)) {
        this.button.html(text);
      }
    },
    get: function get() {
      if ((0, _utilities.hasConstructor)(_jquery2.default, this.button)) {
...
var _chartjs = __webpack_require__(12);
...
var SmartForm = function (_DragBox) {
  ...
  function SmartForm(_ref) {
    var _ref$fields = _ref.fields,
        ...
        deferred = _ref$deferred === undefined ? new _utilities.Deferred() : _ref$deferred,
        _ref$url = _ref.url,
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      fields[key] = (0, _utilities.extend)(baseField, fields[key]);
      ...
      _this.fields[key].bindedField = new _BindedField2.default(_this.fields[key], 'value', _this.fields[key].row, _this.fields[key].type, _this.fields[key].authorizedValues, null, { constraints: _this.fields[key].constraints, title: _this.fields[key].title, baseMessage: _this.fields[key].baseMessage }); // TODO transform the call to an option object with parameters
    }
    if (url !== null) {
      _this.append('</form>');
    }
    ...
    if ((0, _utilities.hasConstructor)(_utilities.Deferred, deferred)) {
      ...
      _this._deferred = new _utilities.Deferred();
      (0, _utilities.debugError)('SmartForm: deferred is not a valid Deferred class. Creating a new one.');
    }
    ...
    // set dragbox title
    _this.title = '<center>' + title + '</center>';
  ...
  _createClass(SmartForm, [{
    ...
    key: 'callThenDestroy',
    value: function callThenDestroy() {
      if ((0, _utilities.hasConstructor)(Function, this.callback)) {
        this.callback(this.fields);
      }

      if ((0, _utilities.hasConstructor)(_utilities.Deferred, this.deferred)) {
    ...
    value: function updatePosition() {
      ...
      if (!this.initialFreeHeigth) {
        ...
        if (this.maxHeight === null) {
          this.maxHeight = this.boxElement.height();
        }
        this.freeHeight = false;
        var fullHeight = innerHeight - 20 - topPos;
        ...
        if (fullHeight > this.maxHeight) {
          ...
          if (this.scrollAppended && this.contentElement.get(0).scrollHeight > this.contentElement.innerHeight()) {
            (0, _jquery2.default)(this.boxElement).find('.smartmodal-scroll').show();
          }
        }
      }

      (0, _utilities.delay)(1).then(function () {
        if (!_this3.scrollAppended && _this3.contentElement.get(0).scrollHeight > _this3.contentElement.innerHeight()) {
          _this3.prepend('<span class="smartmodal-scroll">&darr; scroll down &darr;</span>', '.smartform-buttonrow');
          _this3.scrollAppended = true;
          var scrollElement = (0, _jquery2.default)(_this3.boxElement).find('.smartmodal-scroll');
          _this3.contentElement.scroll(function () {
            if (_this3.contentElement.scrollTop() !== 0) {
              scrollElement.hide();
            } else {
              scrollElement.show();
            }
        ...
        if (_this3.scrollAppended && _this3.contentElement.get(0).scrollHeight > _this3.contentElement.innerHeight()) {
          (0, _jquery2.default)(_this3.boxElement).find('.smartmodal-scroll').show();
        } else if (_this3.scrollAppended) {
          (0, _jquery2.default)(_this3.boxElement).find('.smartmodal-scroll').hide();
        }
      });
    ...
    key: 'promise',
    set: function set(val) {
      (0, _utilities.debugError)('SmartForm: promise is a readonly property, set the deferred property');
    },
    get: function get() {
      if ((0, _utilities.hasConstructor)(_utilities.Deferred, this.deferred)) {
    ...
    key: 'deferred',
    set: function set(val) {
      if ((0, _utilities.hasConstructor)(_utilities.Deferred, val)) {
        this._deferred = val;
      } else {
        (0, _utilities.debugError)('SmartForm: value needs to be of class Deferred');
      }
    },
    get: function get() {
...
var _SmartForm = __webpack_require__(8);
