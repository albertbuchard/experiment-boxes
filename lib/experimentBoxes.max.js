(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jQuery"), require(undefined), require(undefined), require(undefined));
	else if(typeof define === 'function' && define.amd)
		define("experimentBoxes", ["jQuery", "chartjs", "lodash", "mathjs"], factory);
	else if(typeof exports === 'object')
		exports["experimentBoxes"] = factory(require("jQuery"), require("chartjs"), require("lodash"), require("mathjs"));
	else
		root["experimentBoxes"] = factory(root["jQuery"], root["Chart"], root["_"], root["math"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_12__) {
...
function getRow() {
  ...
  matrixObject = _mathjs2.default.matrix(matrixObject);
  var size = matrixObject.size()[0];
  var row = _mathjs2.default.subset(matrixObject, _mathjs2.default.index(rowIndex, _mathjs2.default.range(0, size)));
...
function rowSum() {
  ...
  var size = matrixObject.size()[0];
  if (rows === null) {
    rows = _mathjs2.default.range(0, size - 1);
  }
  ...
  for (var i = 0; i < rows.length; i++) {
    rowSumArray.push(_mathjs2.default.sum(getRow(matrixObject, rows[i])));
  }
...
var _chartjs = __webpack_require__(10);
