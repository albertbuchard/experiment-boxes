  ...
  _createClass(DragBox, [{
    ...
    value: function destroy() {
      ...
      (0, _jquery2.default)(this.boxElement).animate({
        ...
        document.body.addEventListener('keydown', _this.keyfunction);
        document.body.addEventListener('keyup', _this.keyfunction);
        document.body.removeEventListener('click', _this.stopDrag);
