  ...
  _createClass(DragBox, [{
    ...
    value: function updateSize() {
      ...
      if (!this.freeHeight) {
        ...
        (0, _jquery2.default)(this.boxElement).find('.dragbox-container').css({
          height: this.height
        });
...
var BindedField = function (_BindedProperty) {
  ...
  function BindedField() {
    ...
    switch (_this.fieldType) {
      ...
      case 'select':
        ...
        _this.fieldHTML = html + '</select></div>';
        break;
      case 'textaera':
  ...
  _createClass(BindedField, [{
    ...
    value: function update() {
      ...
      } else if (this.field.val().toUpperCase() !== String(this.value).toUpperCase()) {
        this.field.val(this.value);
      }
    }
    ...
    get: function get() {
      if (this.subfields.length) {
        ...
        try {
          for (var _iterator3 = this.subfields[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
